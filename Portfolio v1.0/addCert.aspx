<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addCert.aspx.cs" Inherits="Portfolio_v1._0.WebForm2" %>
...
<html lang="en">
  ...
  <body>
    <div class="mini-sections" >
      ...
      <form
        class="addSthForm" runat="server" id="form2"
      ...
      >
        ...
        <div>
          ...
          <input type="date" id="issuedOn" name="issuedOn" />
        </div>
        <div>
        ...
        <div style="display: flex; justify-content: flex-end; gap: 1rem; flex-direction: row;">
            ...
            <button 
                style="width: fit-content; background-color: green" 
                type="button" 
                runat="server" 
                id="btnAdd" 
